...
| `--date <date>` | current UTC date | Release heading date text; `YYYY-MM-DD` is recommended, explicit values are rendered verbatim, and resolved tag dates remain authoritative when available |
